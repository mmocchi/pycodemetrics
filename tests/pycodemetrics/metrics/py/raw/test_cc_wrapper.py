...
"""
    ...
    # Assert
    expected = [FunctionCognitiveComplexity(function_name="simple_function", complexity=0)]
...
async def async_function():
    pass
"""
    expected = [FunctionCognitiveComplexity(function_name="async_function", complexity=0)]
    result = get_function_cognitive_complexity(code)
    assert result == expected
